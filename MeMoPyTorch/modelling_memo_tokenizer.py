...
class MeMoTokenizer(GPT2TokenizerFast):
    truncation_side = 'left'
    model_input_names: List[str] = ["input_ids", "token_type_ids", "attention_mask"] ### EDITION FOR DOWNSTREAM TASKS.
    ...
    def __call__(
        ...
        return_attention_mask: Optional[bool] = True,                                           ####False,
